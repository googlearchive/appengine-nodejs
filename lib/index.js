 ...
 *
 * @param {!Object} winston log record
 * @return {!string} the resulting string
 */
AppEngine.prototype.loggingStringify_ = function(output) {
  var translate = {
    'silly': 'DEBUG',
    'debug': 'DEBUG',
    'info': 'INFO',
  ...
  var message = output.message.replace('"', '\\"');
  var level = translate[output.level] || 'INFO';
  var a = [
    '{',
    '"timeNanos": ',
    output.timestamp,
